...
const Gallery = () => {
  return (
    <div className="gallery-container w-[1440px] h-[777px] mx-auto p-8">
      {/* Heading */}
      ...
      <div className="grid grid-cols-4 gap-4">
        ...
        <div className="text-center">
          <Image
            src="/sofa1.jpg" // Ensure your image path is correct (relative to the public folder)
            alt="Modern Lamp"
            width={287}
            height={397}
        ...
        <div className="text-center">
          <Image
            src="/sofa2.jpg" // Ensure your image path is correct
        ...
        <div className="text-center py-16">
          <Image
            src="/sofa3.jpg" // Ensure your image path is correct
        ...
        <div className="text-center">
          <Image
            src="/sofa4.jpg" // Ensure your image path is correct
            alt="Table Light"
            width={287}
            height={397}
            className="rounded-md"
